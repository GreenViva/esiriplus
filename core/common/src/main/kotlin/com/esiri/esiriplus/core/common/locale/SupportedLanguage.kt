...
val supportedLanguages = listOf(
    ...
    SupportedLanguage("ar", "Arabic", "\u0627\u0644\u0639\u0631\u0628\u064A\u0629", isRecommended = true),
    SupportedLanguage("en", "English", "English", isRecommended = true),
    SupportedLanguage("es", "Spanish", "Espa\u00F1ol", isRecommended = true),
    SupportedLanguage("fr", "French", "Fran\u00E7ais", isRecommended = true),
    SupportedLanguage("hi", "Hindi", "\u0939\u093F\u0928\u094D\u0926\u0940", isRecommended = true),
